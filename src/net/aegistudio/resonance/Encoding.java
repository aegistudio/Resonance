...
public class Encoding
{
	...
	private static final int WORDTYPE_MAX   = 0x00060000;
	
	public static final String[] wordTypeDescription = new String[]{"integer", "unsigned integer", "float"};
	public static final AudioFormat.Encoding[] wordTypeInstance = new AudioFormat.Encoding[]
			{AudioFormat.Encoding.PCM_SIGNED, AudioFormat.Encoding.PCM_UNSIGNED, AudioFormat.Encoding.PCM_FLOAT};
