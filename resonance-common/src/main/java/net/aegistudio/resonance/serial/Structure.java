...
public class Structure {	
	...
	public <T> T get(String key, Type<T> defaultType) {
	...
	public <T> T get(String key, Type<T> defaultType, T defaultValue) {	
		T value = get(key, defaultType);
		return value == null? defaultValue : value;
	}
	
	public <T> T get(String key, Type<T> defaultType, Callable<T> defaultValue) {
		try {
			T value = get(key, defaultType);
			return value == null? defaultValue.call() : value;
		}
		catch(Exception e) {
			throw new IllegalArgumentException("The default callable generates an exception!");
		}
	}
