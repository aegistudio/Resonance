...
public class LengthKeywordArray<T extends LengthObject> implements KeywordArray<Double, T>
{
	...
	double maximum = 0.0;
	@Override
	public synchronized void add(net.aegistudio.resonance.music.KeywordArray.KeywordEntry<Double, T> entry) {
	...
	@Override
	public synchronized void remove(net.aegistudio.resonance.music.KeywordArray.KeywordEntry<Double, T> entry) {
	...
	@Override
	public synchronized Collection<net.aegistudio.resonance.music.KeywordArray.KeywordEntry<Double, T>> between(Double lowerBound,
			Double upperBound) {
	...
	@Override
	public Collection<net.aegistudio.resonance.music.KeywordArray.KeywordEntry<Double, T>> all() {
